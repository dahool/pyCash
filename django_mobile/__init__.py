#Part of this code are adapted from http://code.google.com/p/minidetector/
...
IGNORE_LIST = dmu_settings.get('IGNORE_LIST') or ()
MOBILE_TEMPLATES_DIR = dmu_settings.get('MOBILE_TEMPLATES_DIR') or ()
USE_REGEX = dmu_settings.get('USE_REGEX') or False
USER_AGENTS_FILE = dmu_settings.get('USER_AGENTS_FILE') or False
